...
class _Calculation:
    ...
    def __init__(self,
        ...
        Args:
            session (Session):
            relative_to (MeshObjectId):  unique way of identifying a Mesh object that contains a time series. Using either a  Universal Unique Identifier for Mesh objects, a |mesh_object_full_name| or a |timskey|
