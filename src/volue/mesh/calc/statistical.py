...
class _StatisticalFunctionsBase(_Calculation, ABC):
    ...
    def _sum_expression(self, input_type_symbol: str, search_query: str | None) -> str:
        """
    ...
    @abstractmethod
    def sum(self, search_query: str | None = None) -> Timeseries:
        """
    ...
    @abstractmethod
    def sum_single_timeseries(self, search_query: str | None = None) -> float:
        """
...
class StatisticalFunctions(_StatisticalFunctionsBase):
    ...
    def sum(self, search_query: str | None = None):
    ...
    def sum_single_timeseries(self, search_query: str | None = None):
        expression = super()._sum_expression(
...
class StatisticalFunctionsAsync(_StatisticalFunctionsBase):
    ...
    async def sum(self, search_query: str | None = None):
        expression = super()._sum_expression(
            _ARRAY_OF_TIMESERIES_CALC_SYMBOL, search_query
        )
    ...
    async def sum_single_timeseries(self, search_query: str | None = None):
        expression = super()._sum_expression(
            _SINGLE_TIMESERIES_CALC_SYMBOL, search_query
        )
        response = await super().run_async(expression)
