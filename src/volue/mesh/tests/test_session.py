...
def test_get_version():
    ...
    connection = Connection(sc.DefaultServerConfig.ADDRESS, sc.DefaultServerConfig.PORT, sc.DefaultServerConfig.ROOT_CERTIFICATE_PATH)
...
async def test_async_get_version():
    ...
    connection = AsyncConnection(sc.DefaultServerConfig.ADDRESS, sc.DefaultServerConfig.PORT, sc.DefaultServerConfig.ROOT_CERTIFICATE_PATH)
