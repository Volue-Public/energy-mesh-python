...
@pytest.mark.database
def test_update_timeseries_attribute_with_invalid_request(session):
    """
...
@pytest.mark.database
def test_search_timeseries_attribute(session):
...
@pytest.mark.database
def test_get_bool_array_attribute(session):
    """
...
@pytest.mark.database
def test_get_xy_set_attribute(session):
    """
...
@pytest.mark.database
def test_get_utc_time_attribute(session):
    """
...
@pytest.mark.database
def test_get_boolean_attribute(session):
    """
...
@pytest.mark.database
def test_get_calc_time_series_attribute(session):
    """
...
@pytest.mark.database
def test_get_physical_time_series_attribute(session):
    """
...
@pytest.mark.database
def test_get_string_attribute(session):
    """
...
@pytest.mark.database
def test_get_double_attribute(session):
    """
...
@pytest.mark.database
def test_get_rating_curve_attribute(session):
    """
...
@pytest.mark.database
def test_search_multiple_attributes(session):
    """
...
@pytest.mark.database
def test_search_with_absent_attribute(session):
    """
...
@pytest.mark.database
def test_update_simple_array_attribute(session):
    """
...
@pytest.mark.database
def test_update_single_simple_attribute(session):
    """
    Check that 'update_simple_attribute' will correctly update single attributes values
    """
    update_double_attribute(session, 5.0) # float provided
    update_double_attribute(session, 13) # int provided
